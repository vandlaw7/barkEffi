...
for epoch in range(epochs):
    ...
    for phase in ['train', 'val']:
        ...
        if phase == 'val' and epoch_acc > best_acc:
            ...
            best_acc = epoch_acc
            best_model_weights = copy.deepcopy(model.state_dict())
            torch.save(best_model_weights, './weights/barknet/best_weights_b0_class_17_aug_100.pth')
            torch.save({
                'epoch': epoch,
                ...
                'epoch_acc': epoch_acc
            }, './weights/barknet/best_weights_b0_class_17_aug_chk_100.pth')
